...
void enqueue_job (int id/* Pass job-specific data here... */)
{
    struct job* new_job;
...
int main()
{
    ...
    for (int i = 1; i <= 10; i++) {
        ...
        enqueue_job(i);
        sleep(0.2); // simula llegada de trabajos en el tiempo
    }

    /* Esperar a que terminen (nunca terminan) */
    for (int i = 0; i < 3; i++) {
